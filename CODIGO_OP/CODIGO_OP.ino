...
#define HS_AUTO 34 //PINO 13 QUANDO TROCAR PRO UM ESP EM QUE O PINO NAO ESTEJA QUEIMADO E ATIVAR HS_508 NO CODIGO
...
bool estado_HS_500, estado_HS_501, estado_HS_502, estado_HS_504, estado_HS_505, estado_HS_503, estado_HS_506, estado_HS_507, estado_HS_508 = 0; //Variaveis para operação manual
...
String estadoCaptando, estadoProcessando, estadoDistribuindo, estadoAutoMan;
...
void setup() {
  ...
  modb.addCoil(0); //COIL[0] alertará que houve um comando no supervisório
  ...
  modb.addCoil(16); //COIL[16] endereço livre
  ...
  modb.addCoil(32); //COIL[32] endereço livre
...
void loop() {
  ...
  //Serial.println(digitalRead(HS_AUTO));
  if (digitalRead(HS_AUTO) == true) {
  ...
  else if (digitalRead(HS_AUTO == false)) {
...
void Checar_Botoes() {                      //Função que identifica se algum botão foi pressionado
  estado_HS_500 = (!digitalRead(HS_500) + modb.Coil(17));
  ...
  estado_HS_501 = (!digitalRead(HS_501) + modb.Coil(18));
  ...
  estado_HS_502 = (!digitalRead(HS_502) + modb.Coil(24));      //botao da valvula de descida
  ...
  estado_HS_504 = (!digitalRead(HS_504) + modb.Coil(19));         //botao das bombas peristalticas
  ...
  estado_HS_505 = (!digitalRead(HS_505) + modb.Coil(20));   //botao do MB_505
  ...
  estado_HS_503 = (!digitalRead(HS_503) + modb.Coil(9));         //botao da valvula que leva ao tanque de agua suja
  ...
  estado_HS_506 = (!digitalRead(HS_506) + modb.Coil(21));             //botao da bomba de descarte
  ...
  estado_HS_507 = (!digitalRead(HS_507) + modb.Coil(22));             //botao da bomba que leva aos filtros
  ...
  /*estado_HS_508 = !digitalRead(HS_508);             //botao da bomba que enche o tanque do bloco A (QUANDO HS_AUTO FOR CONFIGURADO PARA O PINO 13 PODE DESCOMENTAR)
