...
var caregaRemotoLocal = loadData('statusLocalRemoto',updateRemotoLocal);
var aatualizaRemotoLocal = setInterval(updateRemotoLocal,800);
...
function atualizaRemotoLocal(){
    if (document.getElementById('remotoLocal').value =="Local"){
